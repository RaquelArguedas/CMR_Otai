...
export const ModificarEvaluacion = () => {
    ...
    const handleSearch = async () => { 
        console.log("GET IN");
        // Obtener información existente en la base de datos
        const res = await fetch(`${API}/readEvaluacion/${1}`); // Cambia el 1 por el ID deseado
        console.log("DESPUES DEL FETCH", res);
        
        const data = await res.json(); // Esperar a que la promesa se resuelva y obtener los datos
        console.log("DATAAAAAAAAAAA"); // imprime en consola web
