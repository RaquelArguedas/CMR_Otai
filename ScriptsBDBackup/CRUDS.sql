...
GO
-- Read (Leer informaci�n de un perfil por ID):
...
GO
-- Read (Leer informaci�n de un estado por ID):
...
GO
-- Read (Leer informaci�n de un funcionario por ID):
...
GO
-- Read (Leer informaci�n de una modalidad por ID):
...
-- Create (Insertar un nuevo tipo de capacitaci�n):
...
GO
-- Read (Leer informaci�n de un tipo de capacitaci�n por ID):
...
GO
-- Update (Actualizar un tipo de capacitaci�n por ID):
...
GO
-- Delete (Eliminar un tipo de capacitaci�n por ID):
...
-- Create (Insertar un nuevo tipo de evaluaci�n):
...
GO
-- Read (Leer informaci�n de un tipo de evaluaci�n por ID):
...
GO
-- Update (Actualizar un tipo de evaluaci�n por ID):
...
GO
-- Delete (Eliminar un tipo de evaluaci�n por ID):
...
GO
-- Read (Leer informaci�n de un cliente por ID):
...
GO
-- Read (Leer informaci�n de un proyecto por ID):
...
GO
-- Tabla Evaluacion
-- Create (Insertar una nueva evaluaci�n):
...
GO
-- Read (Leer informaci�n de una evaluaci�n por ID):
...
GO
-- Update (Actualizar una evaluaci�n por ID):
...
GO
-- Delete (Eliminar una evaluaci�n por ID):
...
GO
-- Tabla Capacitacion
-- Create (Insertar una nueva capacitaci�n):
...
GO
-- Read (Leer informaci�n de una capacitaci�n por ID):
...
GO
-- Update (Actualizar una capacitaci�n por ID):
...
GO
-- Delete (Eliminar una capacitaci�n por ID):
...
GO
-- Read (Leer informaci�n de un usuario por ID):
...
GO
-- Read (Leer informaci�n de porcentajes por ID):
...
GO
-- Tabla Cotizacion
-- Create (Insertar una nueva cotizaci�n):
...
GO
-- Read (Leer informaci�n de una cotizaci�n por ID):
...
GO
-- Update (Actualizar una cotizaci�n por ID):
...
GO
-- Delete (Eliminar una cotizaci�n por ID):
...
-- Create (Insertar una nueva relaci�n ProyectoXFuncionario):
...
GO
-- Read (Leer informaci�n de una relaci�n ProyectoXFuncionario por ID):
...
GO
-- Update (Actualizar una relaci�n ProyectoXFuncionario por ID):
...
GO
-- Delete (Eliminar una relaci�n ProyectoXFuncionario por ID):
